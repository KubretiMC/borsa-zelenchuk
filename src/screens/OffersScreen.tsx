...
const OffersScreen: React.FC = () => {
    ...
    console.log('filterValues', filterValues.maxCost);
    const stocksList = [
        ...
        { id: 3, good:'Диня', place: 'Огняново', cost: 1.2, image: 'https://zemedeleca.bg/wp-content/uploads/2023/05/%D0%94%D0%B8%D0%BD%D0%B8.jpg' },
    ...
    const filteredStocksList = stocksList.filter((stock) => {
        ...
        const goodMatch = good === 'all' || stock.good === good;
        const placeMatch = place === 'all' || stock.place === place;
    ...
    return (
        <ScreenContainer subtitle='Random Randomov'>
            <Filter stocksList={stocksList} filterValues={filterValues} setFilterValues={setFilterValues} />
            {offerList}
        </ScreenContainer>
    );
};
